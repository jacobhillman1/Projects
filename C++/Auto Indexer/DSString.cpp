...
{
    int tempLen = len;
    return tempLen; // returns the length of the c-string stored in the object, not counting the null-terminator. This value is already stored in len
}

//if the string contains a number, this function will return it as an int
int String::extractNumber()
{
    char tempNum[99];
    int loc = 0;
